...
class Menu:
    ...
    def choose_unit(self):
        ...
        while True:
            user_prompt = input(
                'This is choosing menu. Type "help" to see available units. To choose an unit, type its name here. To exit menu, type "exit".')
    ...
    def sandbox_mode(self):
        ...
        while True:
            ...
            user_unit = self.engine.unitdict.get(user_unit[0])(y=int(coords[1]), x=int(coords[0]), team='Red')
            self.engine.display()
            print('Done!')
        ...
        while True:
            ...
            coords = user_place.split(',')
            print(user_place)
            unit = self.engine.unitdict.get(user_unit[0])(y=int(coords[1]), x=int(coords[0]), team='Blue')
            self.engine.display()
            print('Done!')
    ...
    def random_battle(self):
        self.engine.generate_blue(random.randint(5, 15))
        self.engine.generate_red(random.randint(5, 15))
        self.engine.display()
